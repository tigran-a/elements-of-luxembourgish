...
\section*{I. Le Verbe \textbf{Kommen} (Venir) - Conjugaison}
...
\section*{II. Le Verbe \textbf{Goen} (Aller) - Conjugaison}
\subsection*{A. Présent (Präsens)}
\begin{tabular}{ll c l l}
\toprule
\textbf{Pronom} & \textbf{Lëtzebuergesch} & \textbf{} & \textbf{Français} & \textbf{English} \\
...
\section*{III. Les Mots Interrogatifs (Question Words)}
\begin{itemize}
...
\begin{minipage}[t]{0.48\textwidth}
	...
	\framebox{\parbox{0.9\linewidth}{\centering
			\vspace{0.5cm}
			\includegraphics[width=0.9\linewidth]{vokab/famill.png} \\
...
\begin{minipage}[t]{0.48\textwidth}
	...
	\framebox{\parbox{0.9\linewidth}{\centering
			\vspace{0.5cm}
			\includegraphics[width=0.9\linewidth]{vokab/ech.png} \\
...
\begin{minipage}[t]{0.48\textwidth}
	...
	\framebox{\parbox{0.9\linewidth}{\centering
			\vspace{0.5cm}
			\includegraphics[width=0.9\linewidth]{vokab/papp.png} \\
...
\begin{minipage}[t]{0.48\textwidth}
	...
	\framebox{\parbox{0.9\linewidth}{\centering
			\vspace{0.5cm}
			\includegraphics[width=0.9\linewidth]{vokab/mamm.png} \\
...
\begin{minipage}[t]{0.48\textwidth}
	...
	\framebox{\parbox{0.9\linewidth}{\centering
			\vspace{0.5cm}
			\includegraphics[width=0.9\linewidth]{vokab/jong.png} \\
...
\begin{minipage}[t]{0.48\textwidth}
	\centering
	\textbf{Meng Duechter / Mäi Mädschen}
	\vspace{0.5em}
	\framebox{\parbox{0.9\linewidth}{\centering
			\vspace{0.5cm}
			\includegraphics[width=0.9\linewidth]{vokab/duechter.png} \\
