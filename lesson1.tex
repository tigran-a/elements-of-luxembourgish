...
\title{\vspace{-3em}\textbf{\Huge Lëtzebuergesch (Luxembourgish): Leçon 1}}
\author{\large Le Verbe \textbf{Hunn} (Avoir) et \textbf{Sinn} (Être) et Vocabulaire de Base}
\date{\textit{Ôpen Junglister}}

\begin{document}
	\maketitle
	\thispagestyle{empty}
	
	\hrule height 1.5pt \vspace{0.5em}\color{black}
	
	\section*{I. Le Verbe \textbf{Hunn} (Avoir) - Conjugaison}
	...
	\section*{II. Le Verbe \textbf{Sinn} (Être) - Conjugaison}
	\subsection*{A. Présent (Präsens)}
	\begin{tabular}{ll c l l}
		\toprule
		\textbf{Pronom} & \textbf{Lëtzebuergesch} & \textbf{} & \textbf{Français} & \textbf{English} \\
	...
	\section*{III. Phrases Clés et Adjectifs}
	...
	\section*{IV. Vocabulaire Illustré : Articles et Pluralité}
	...
	\begin{minipage}[t]{0.48\textwidth}
		...
		\framebox{\parbox{0.9\linewidth}{\centering
				\vspace{0.5cm}
				\includegraphics[width=0.9\linewidth,clip, trim=0 5cm 0 5cm ]{vokab/metsch.png} \\
	...
	\begin{minipage}[t]{0.48\textwidth}
		...
		\framebox{\parbox{0.9\linewidth}{\centering
				\vspace{0.5cm}
				\includegraphics[width=0.9\linewidth,clip, trim=0 5cm 0 5cm ]{vokab/metschen.png} \\
	...
	\begin{minipage}[t]{0.48\textwidth}
		...
		\framebox{\parbox{0.9\linewidth}{\centering
				\vspace{0.5cm}
				\includegraphics[width=0.9\linewidth,clip, trim=0 3cm 0 3cm ]{vokab/buch.jpg} \\
	...
	\begin{minipage}[t]{0.48\textwidth}
		...
		\framebox{\parbox{0.9\linewidth}{\centering
				\vspace{0.5cm}
        \includegraphics[width=0.9\linewidth,clip, trim=0 3cm 0 3cm  ]{vokab/bicher.jpg} \\
	...
	\end{tabular}
		...
		\framebox{\parbox{0.9\linewidth}{\centering
				\vspace{0.5cm}
				\includegraphics[width=0.9\linewidth,clip, trim=0 3cm 0 3cm  ]{vokab/auto.jpg} \\
	...
	\begin{minipage}[t]{0.48\textwidth}
		...
		\framebox{\parbox{0.9\linewidth}{\centering
				\vspace{0.5cm}
				\includegraphics[width=0.9\linewidth,clip, trim=0 3cm 0 3cm  ]{vokab/autoen.jpg} \\
	...
	\begin{center}
		\begin{minipage}[t]{0.48\textwidth}
			...
			\framebox{\parbox{0.9\linewidth}{\centering
					\vspace{0.5cm}
					\includegraphics[width=0.9\linewidth]{vokab/angscht.png} \\
	...
	\begin{center}
		\begin{minipage}[t]{0.48\textwidth}
			...
			\framebox{\parbox{0.9\linewidth}{\centering
					\vspace{0.5cm}
					\includegraphics[width=0.9\linewidth]{vokab/schnapp.png} \\
